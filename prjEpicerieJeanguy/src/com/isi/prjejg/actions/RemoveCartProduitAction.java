...
public class RemoveCartProduitAction extends Action {

	public RemoveCartProduitAction(ConnecteurBD cbd, String destOk, String destBad, boolean reqLogin) {
	...
	public void doTheJob(HttpServletRequest request, HttpServletResponse response) {
		...
		cpm.removeCartProduit(clientId, produitId);
